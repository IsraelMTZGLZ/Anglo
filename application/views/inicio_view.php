...
<head>
	...
	<link href="<?=base_url('resources/dashboard/source/assets/plugins/summernote/summernote.css');?>" rel="stylesheet">
	...
	<!-- inbox style -->
	<link href="<?=base_url('resources/dashboard/source/assets/css/pages/inbox.min.css');?>" rel="stylesheet" type="text/css" />
	<!-- Theme Styles -->
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-indigo">
	...
	<script src="<?=base_url('resources/dashboard/source/assets/plugins/sparkline/jquery.sparkline.js');?>"></script>
	<script src="<?=base_url('resources/dashboard/source/assets/js/pages/sparkline/sparkline-data.js');?>"></script>
	<!-- Common js-->
	...
	<script src="<?=base_url('resources/dashboard/source/assets/js/pages/chart/chartjs/home-data.js');?>"></script>
	<!-- summernote -->
	<script src="<?=base_url('resources/dashboard/source/assets/plugins/summernote/summernote.js');?>"></script>
