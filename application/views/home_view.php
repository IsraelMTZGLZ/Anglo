	...
	<div class="flexslider carousel">
		<ul class="slides">
			<li>
				<div class="filter-box">
					<div class="filter-image">
						<img src="<?=base_url('resources/assets/images/01.jpg');?>" alt="">
					</div>
					<div class="filter-hover">
						<a href="#" class="filter-popup" data-effect="mfp-zoom-in"></a>
					</div>
                </div>
			</li>
			<li>
				<div class="filter-box">
					<div class="filter-image">
						<img src="<?=base_url('resources/assets/images/02.jpg');?>" alt="">
					</div>
					<div class="filter-hover">
						<a href="#" class="filter-popup" data-effect="mfp-zoom-in"></a>
					</div>
			...
			<li>
				<div class="filter-box">
					<div class="filter-image">
						<img src="<?=base_url('resources/assets/images/03.jpg');?>" alt="">
					</div>
					<div class="filter-hover">
						<a href="#" class="filter-popup" data-effect="mfp-zoom-in"></a>
					</div>
			...
			<li>
				<div class="filter-box">
					<div class="filter-image">
						<img src="<?=base_url('resources/assets/images/04.jpg');?>" alt="">
					</div>
					<div class="filter-hover">
						<a href="#" class="filter-popup" data-effect="mfp-zoom-in"></a>
					</div>
